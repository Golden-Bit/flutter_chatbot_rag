...
NOTA IMPORTANTISSIMA: DOVRAI EFFETTUARE SOLAMENTE UNA RICERCA NEL VECTORSTORE , NON DOVRAI MAI ASOLUTAMENTE EFFETTUARE RICERCHE MULTIPLE IN UNA STESSA RISPOSTA!!!
''',
    params: const [
      // Identificativi
      ToolParamSpec(
