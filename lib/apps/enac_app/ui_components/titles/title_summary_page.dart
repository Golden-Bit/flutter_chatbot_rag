...
// ═══════════════════════════════════════════════════════════════
// TitleSummaryPanel (SUMMARY) – header con pulsanti in alto a destra
// + Riepilogo dati titolo (nessun Scaffold/Tab/Chat)
// ═══════════════════════════════════════════════════════════════
...
/// ───────────────────────────────────────────────────────────────
/// Azioni header (in alto a destra) – stile coerente agli altri
/// ───────────────────────────────────────────────────────────────
class _HeaderActionIconsTitle extends StatelessWidget {
  const _HeaderActionIconsTitle();
