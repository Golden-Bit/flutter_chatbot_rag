...
class _ContactManagerPageState extends State<ContactManagerPage> {
  ...
  void _addOrUpdateContact(Contact contact, {Contact? existingContact}) {
    setState(() {
      if (existingContact != null) {
        // Se esiste un contatto, aggiorna i suoi dati
        ...
        // Se non esiste un contatto, aggiungi un nuovo contatto
        if (contact.isPerson) {
